...
svyplot(BMXWAIST~RIDAGEYR, design = subset(postStratify(design5,~race+RIAGENDR+agecat,racegenderage3),RIDAGEYR>=20)  , style = "bubble")
...
positions <- c("Always","Most of the \n Time", "Sometimes", "Rarely" , "Never")
ggplot(graphCombine5, aes(factor(CBQ020), FREQ, fill = test)) + 
...
positions <- c("Always","Most of the \n Time", "Sometimes", "Rarely" , "Never")
ggplot(graphCombine4, aes(factor(CBQ030), FREQ, fill = test)) + 
...
positions <- c("Always","Most of the \n Time", "Sometimes", "Rarely" , "Never")
ggplot(graphCombine3, aes(factor(CBQ040), FREQ, fill = test)) + 
...
positions <- c("Always","Most of the \n Time", "Sometimes", "Rarely" , "Never")
ggplot(graphCombine2, aes(factor(CBQ060), FREQ, fill = test)) + 
...
positions <- c("Excellent","Very good", "Good", "Fair", "Poor")
ggplot(graphCombine, aes(factor(DBQ700), FREQ, fill = test)) + 
...
positions <- c("Excellent","Very good", "Good", "Fair", "Poor")
ggplot(newDB2, aes(factor(DBQ700), FREQ, fill = test)) + 
...
positions <- c("Excellent","Very good", "Good", "Fair", "Poor")
ggplot(testr, aes(factor(HSD010), FREQ, fill = test)) + 
...
positions <- c("Excellent","Very good", "Good", "Fair", "Poor")
ggplot(newDB, aes(factor(HSD010), FREQ, fill = test)) + 
  geom_bar(stat="identity", position = "dodge" , colour = "black" ) +labs(title = "How would you rate your overall health? ", y = "PCT")+ scale_x_discrete(limits = positions) + geom_text(aes(label=round(FREQ , 2)), position=position_dodge(width=0.9), vjust=-0.25) + scale_fill_manual(values=wes_palette(n=4, name="Moonrise2"))
